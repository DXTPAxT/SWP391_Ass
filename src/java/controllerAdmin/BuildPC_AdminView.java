 ...
 * @author PC
 */
@WebServlet(name = "BuildPC_AdminView", urlPatterns = {"/BuildPC_AdminView"})
public class BuildPC_AdminView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       List<BuildPCView> buildPCList = dao.getBuildPCSummaryView();
        ...
        // Forward đến đúng trang JSP hiển thị danh sách Build PC
