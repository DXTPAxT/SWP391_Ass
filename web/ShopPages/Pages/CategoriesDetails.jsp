...
<html lang="en">
    <head>
        ...
        <link href="${ctx}/ShopPages/Pages/css/custom.css" rel="stylesheet">
        <!--[if lt IE 9]>
                            ...
                            <div class="container mt-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Price:</strong> <span style="color:#e74c3c;font-weight:600;">${product.price} VND</span></p>
                                        <p><strong>Description:</strong></p>
                                        <p class="text-muted" id="descShort">${product.description}</p>
                                        <button class="see-more-btn" id="seeMoreBtn" onclick="toggleDescription()">Xem chi tiết</button>
