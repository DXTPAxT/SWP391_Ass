                    ...
                    <div class="col-sm-4 col-sm-offset-1">
                        <div class="login-form"><!--login form-->
                            ...
                            <form action="Login" method="post">
                                <input type="text" placeholder="Email address" class="form-control ${not empty error ? "is-invalid" : ''}" name="email" placeholder="Enter email" required="" value="${not empty error ? email : ''}"/>
                                <input type="password" placeholder="Password" class="form-control ${not empty error ? "is-invalid" : ''}" name="password" placeholder="Enter password" required="" value="${not empty error ? password : ''}"/>
                                <span>
