            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div>
                            <ul>
                                <li><a href="${ctx}/blogc" style="color: black">All</a></li>
                                <c:forEach var="cat" items="${blog_categories}">
                                    <li>
                                        <a href="${ctx}/blogc?Bc_id=${cat.bc_id}" style="color: black;">${cat.bc_name}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                        <div class="shipping text-center">
                            <img src="${ctx}/ShopPages/Pages/images/home/" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-9">
                    <div class="blog-post-area">
                        <h2 class="title text-center">Blog Post Details</h2>
                        <div class="single-blog-post">
                            <h1 class="post-title">${post.title}</h1>
                            <div class="post-meta">
                                <p>${post.author} | ${categoryName} | ${post.updated_date}</p>
                            </div>
                            <c:if test="${not empty post.thumbnail}">
                                <div class="post-thumbnail">
                                    <img src="${post.thumbnail}" alt="${post.title}" style="width: 100%; height: auto; border-radius: 8px; margin-bottom: 20px;">
                                </div>
                            </c:if>
