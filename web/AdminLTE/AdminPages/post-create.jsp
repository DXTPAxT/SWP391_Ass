...
<jsp:useBean id="blog_categories" scope="request" type="java.util.List" />
<html>
<head>
...
<body>
    <div class="container form-container">
        ...
        <form action="bloga" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <label for="bc_id">Danh mục:</label>
                <select class="form-control" id="bc_id" name="bc_id" required>
                    <option value="">Chọn danh mục</option>
                    <c:forEach items="${blog_categories}" var="c">
                        <option value="${c.bc_id}"><c:out value="${c.bc_name}" /></option>
                    </c:forEach>
                </select>
                <small class="error-message" id="bc_id-error"></small>
            </div>
            <div class="form-group">
                <label for="add_id">Admin ID:</label>
