            ...
            <div class="box-body">
                ...
                <form method="post" action="${ctx}/User">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="address" name="address" class="form-control${error eq 'Address is required!' ? ' is-invalid' : ''}" required value="${user.address}">
                    </div>
                    <div class="form-group">
                        <label for="roleID">Role</label>
                        <input type="text" id="roleID" name="roleID" class="form-control" readonly 
                            value="<c:choose><c:when test='${not empty roleMap}'>${roleMap[user.roleID]}</c:when><c:otherwise>${user.roleID}</c:otherwise></c:choose>">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="${ctx}/Admin/user" class="btn btn-default">Cancel</a>
                </form>
            </div>
        </div>
    </div>
